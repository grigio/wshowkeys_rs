...
fn create_test_config() -> Config {
    Config {
        ...
        special_color: 0x00FF00FF,     // Green for special keys
        ...
        anchor: AnchorPosition {
            ...
            left: false,
            right: true,   // Anchor to right (bottom-right corner)
        },
...
fn main() -> Result<()> {
    ...
    println!("Single key displayed: {}x{}", single_result.width, single_result.height);
    ...
    println!("Combination displayed: {}x{}", combo_result.width, combo_result.height);
    ...
    println!("Complex combination displayed: {}x{}", complex_result.width, complex_result.height);
    ...
    println!("3. 'Ctrl+Shift+T' combination displayed for 3 seconds");
